    ...
    <section className={`${ingredientsStyles.constructor} pt-10`}>
      ...
      {ingredientsRequest === "success" && (
        <div className={`${ingredientsStyles.ingredients} mt-10`}>
          <IngredientsList
            idTag={ItemType.Bun.TYPE}
            itemList={buns}
            itemType={ItemType.Bun}
            categoryRef={bunsRef}
          />
          <IngredientsList
            idTag={ItemType.Sauce.TYPE}
            itemList={sauce}
            itemType={ItemType.Sauce}
            categoryRef={saucesRef}
          />
          <IngredientsList
            idTag={ItemType.Main.TYPE}
            itemList={main}
            itemType={ItemType.Main}
            categoryRef={mainsRef}
          />
        </div>
      )}
    </section>
